#if UNITY_EDITOR
// from https://gist.github.com/alexanderameye/c1f99c6b84162697beedc8606027ed9c
...
public static class EditorSceneSwitcher {
    public static bool AutoEnterPlaymode;
...
public class SceneDropdown : EditorToolbarDropdown {
    ...
    private void ToggleDropdown() {
        ...
        foreach (string scenePath in EditorSceneSwitcher.ScenePaths) {
...
public class AutoEnterPlayModeToggle : EditorToolbarToggle {
    ...
    public AutoEnterPlayModeToggle() {
        GUIContent content = EditorGUIUtility.TrTextContentWithIcon("", Tooltip, "d_preAudioAutoPlayOff");
        text = content.text;
        tooltip = content.tooltip;
        icon = content.image as Texture2D;
