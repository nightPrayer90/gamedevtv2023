...
public class RipplePostProcessor : MonoBehaviour
{
    ...
    public void RippleEffect(float posX , float posY, float MaxAmount, float _Friction)
    {
        CurrentAmount = MaxAmount;
        ...
        RippleMaterial.SetFloat("_CenterX", posX);
        RippleMaterial.SetFloat("_CenterY", posY);
    ...
    void Update()
    {
        ...
        {
            RippleEffect(Input.mousePosition.x, Input.mousePosition.y, 3, 0.9f);
        }*/
